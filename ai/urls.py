...
urlpatterns = [
    ...
    path(
        "projects/<int:analysis_id>/swot/",
        groq_project_swot,
        name="groq_project_swot",
    ),
    path(
        "projects/<int:analysis_id>/speech/",
        groq_project_speech,
        name="groq_project_speech",
    ),
    path(
        "projects/<int:analysis_id>/speech/slides/",
        groq_project_speech_slides,
        name="groq_project_speech_slides",
    ),
    path(
        "projects/<int:analysis_id>/sprint/",
        groq_project_sprint,
        name="groq_project_sprint",
    ),
